        ...
        <div class="flex flex-col md:flex-row md:gap-x-8">
            <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                <div class="flex flex-col lg:flex-row gap-x-4">
                    ...
                    <div>
                        <h4 class="font-body text-xl mb-1">Bir sorunuz mu var?</h4>
                        <p class="text-paragraph mb-1">Size yardım etmek için buradayım.</p>
                        <p class="text-accent font-normal">Email Adresim bicakcioguz@gmail.com</p>
                    </div>
                </div>
                <div class="flex flex-col lg:flex-row gap-x-4">
                    <div
                    ...
                    <div>
                        <h4 class="font-body text-xl mb-1">Yaşadığım Şehir / Ülke</h4>
                        <p class="text-paragraph mb-1">Mersin / Türkiye</p>
                        {{-- <p class="text-accent font-normal">Serving clients worldwide.</p> --}}

                    </div>
                </div>
            </div>
            <form method="POST" action="{{ route('sendMail') }}" class="space-y-8 w-full max-w-md">
                @csrf
                @method('POST')
                <div class="flex gap-8">
                    ...
                    <div>
                        <input class="input" type="email" name="email" placeholder="Email Giriniz" required />
                    </div>
                </div>
                <textarea name="body" class="textarea" placeholder="Mesajınız..." spellcheck="false"required></textarea>
                <button type="submit"
