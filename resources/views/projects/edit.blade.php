    ...
    <div class="py-12">
        <div class="max-w-md mx-auto sm:px-6 lg:px-8 bg-white shadow-md rounded-md">
            <form method="POST" action="{{ route('projects.update', $project->id) }}" class="p-4"
                ...
                @csrf
                @method('PUT')
                <label for="skill_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Beceri
                    Seç</label>
                ...
                <div class="mt-2">
                    <x-input-label for="name" :value="__('Proje Adı')" />
                ...
                <div class="mt-2">
                    <x-input-label for="project_url" :value="__('Proje Url')" />
